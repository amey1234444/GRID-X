  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <header className="sticky top-0 z-30 border-b border-border-subtle glass">
        ...
        <nav className="flex gap-1 overflow-x-auto border-t border-border-subtle px-4 py-2">
          {INSPECTOR_NAVIGATION.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  'flex shrink-0 items-center gap-2 rounded-lg px-3 py-1.5 text-sm transition-colors duration-200',
                  active
